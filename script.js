...
const drawRect = (e) => {
    // if fillColor isn't checked draw a rect with border else draw rect with backround 
...
const startDraw = (e) => {
    ...
    ctx.beginPath(); // creating new path draw
    ctx.lineWidth =brushwidth; // passing brushSize as line width
    ctx.strokeStyle = selectedColor; // passing selectedColor as stroke style 
    ctx.fillStyle = selectedColor; // passing selectedColor as stroke style 
...
const drawing = () => {
    ...
    if(selectedTool === "brush" || selectedTool === "eraser") {
        // if selcted tool is eraser then set strokestyle to white
...
saveImg.addEventListener("click", () => {
    ...
    link.href = canvas.toDataURL(); // passing canvasData as link herf value 
